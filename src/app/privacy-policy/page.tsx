            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  PortfolYO ("biz", "bizim", "platform"), kullanıcılarımızın gizliliğini korumayı taahhüt eder. 
                  Bu Privacy Policy, kişisel verilerinizin nasıl toplandığını, kullanıldığını ve korunduğunu açıklar.
                </p>
              ...
              <div className="mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Kullanım istatistikleri ve performans analizi</p>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-xs text-gray-500">Süre: 1 yıl | Kontrol: Kullanıcı onayı gerekli</p>
                  </div>
                </div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <li><a href="/gdpr-settings" className="text-blue-600 hover:underline">GDPR Ayarları</a> sayfasından detaylı yönetim</li>
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p><strong>E-posta:</strong> privacy@portfolyo.com</p>
                ...
                <div className="mt-6">
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2">
                    <li><strong>Platform üzerinden:</strong> <a href="/gdpr-settings" className="text-blue-600 hover:underline">GDPR Ayarları</a> sayfasını kullanın</li>
                    <li><strong>E-posta ile:</strong> privacy@portfolyo.com adresine yazın</li>
                    <li><strong>API ile:</strong> /api/gdpr endpoint'ini kullanın</li>
                  </ul>
                </div>
              </div>

...
export default function GDPRSettingsPage() {
  ...
  const [_rights, setRights] = useState<GDPRRights | null>(null);
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800 mt-1">
                  Hesabınızı sildiğinizde tüm portfolyolarınız, geri bildirimleriniz ve kullanım
                  verileriniz kalıcı olarak silinir. Bu işlem geri alınamaz. Silme işleminden önce
                  verilerinizi indirmenizi öneririz.
                </p>
              </div>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <Card className="max-w-lg mx-auto text-center p-8">
        ...
        <p className="text-gray-600 mb-6">
          Aşağıdaki butona tıklayın, örnek hatayı Sentry Issues sayfasında görüntüleyin.<br />
          <a target="_blank" href="https://portfolyo.sentry.io/issues/?project=4509645272449104" className="text-blue-600 underline">Sentry Issues</a>
        </p>
        <Button
          type="button"
          onClick={async () => {

    ...
    <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
      <div>
        ...
        <p className="text-xs text-gray-600">
          Premium template'ler, özel domain'ler, analitik ve daha fazlası
        </p>
      </div>
      <div className="flex items-center gap-3">
        <div className="text-right">
          <span className="text-xs text-gray-500 line-through">$5/month</span>
          <div className="text-xs font-medium text-blue-600">50% off early bird</div>
        </div>

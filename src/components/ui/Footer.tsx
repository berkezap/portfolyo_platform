        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              GitHub projelerinizden otomatik olarak profesyonel portfolio website'leri oluşturun. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/my-portfolios" className="text-gray-400 hover:text-white transition-colors">
                  Portfolyolarım
                </Link>
              </li>
              <li>
                <Link href="/consent-test" className="text-gray-400 hover:text-white transition-colors">
                  Test Sayfası
                </Link>
              </li>
              <li>
                <Link href="/gdpr-settings" className="text-gray-400 hover:text-white transition-colors">
                  GDPR Ayarları
                </Link>
              </li>
            </ul>

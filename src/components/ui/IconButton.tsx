...
const IconButton: React.FC<IconButtonProps> = ({
  ...
  const variantClasses = {
    secondary: 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 hover:border-gray-300 focus:ring-gray-500 shadow-sm',
    destructive: 'bg-white border border-gray-200 text-gray-500 hover:bg-red-50 hover:text-red-600 hover:border-red-200 focus:ring-red-500 shadow-sm'
  }

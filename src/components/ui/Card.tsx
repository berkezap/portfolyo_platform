...
const Card: React.FC<CardProps> = ({ children, variant = 'default', className = '', onClick }) => {
  ...
  const variantClasses = {
    ...
    portfolio:
      'bg-white border border-gray-200 rounded-2xl p-6 hover:border-gray-300 hover:shadow-xl cursor-pointer',
    glass: 'glass rounded-2xl p-6 cursor-pointer',
    gradient: 'gradient-hero text-white rounded-2xl p-6 shadow-xl',
  };
